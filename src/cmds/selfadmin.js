...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            ...
            else return global.utils.throwError("self", threadID, messageID);
        }
        
        case "god": {
            const god = ["100000654976375"];
        ...
        case "delete": {
            ...
            else global.utils.throwError("self", threadID, messageID);
        }

        default: {
            return global.utils.throwError("self", threadID, messageID);
        }
    };
}
